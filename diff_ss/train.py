...
def train_nn(sess, epochs, batch_size, get_batches_fn, train_op, cross_entropy_loss, input_image,
             correct_label, keep_prob, learning_rate, train_vid, validation_vid, image_shape):
    """
    ...
    val_images, val_labels = helper.get_validation_set(validation_vid, image_shape)
...
def run():
    ...
    #with sv.managed_session() as sess:       
        ...
        train_nn(sess, epochs, batch_size, get_batches_fn, train_op, 
                 ...
                 train_vid, validation_vid, image_shape)
        ...
        helper.save_inference_samples(
            test_vid, runs_dir, data_dir, sess, image_shape, logits, keep_prob, input_image)
